...
tables = { -- Spawns Ped Only -- Setup Currently For This https://forum.cfx.re/t/cayo-perico-casino-dlc-ipl-loader/2099391
	{
		coords = vector4(1036.81, 50.91, 68.06, 13.16), --Table 1
		highStakes = false
	},
	{
		coords = vector4(1044.39, 52.66, 68.06, 13.47), --Table 2
		highStakes = false
	},
	{
		coords = vector4(1043.42, 56.8, 68.06, 193.47), --Table 3
		highStakes = false
	},
	{
		coords = vector4(1035.85, 55.02, 68.06, 193.16), --Table 4
		highStakes = false
	},
	{
		coords = vector4(1033.82, 41.51, 68.86, 283.16), --Table 5
		highStakes = false
	},
	{
		coords = vector4(1027.86, 40.08, 68.86, 103.47), --Table 6
		highStakes = false
	},
}
